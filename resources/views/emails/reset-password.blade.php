            ...
            <table role="presentation"
                ...
                <tr style="border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;">
                    <td align="left" style="padding:10px 25px;background:#fff; display: flex; align-items: center;">
                        <span style="font-weight: bold; padding-top: 10px;"> Адвокатская контора "Правовой арсенал" </span>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td style="padding:0 0 36px 0;color:#153643;">
                                    ...
                                    <p
                                        ...
                                        Вы можете сбросить пароль, нажав на кнопку ниже:
                                    </p>

                                    <p style="text-align: center;">
                                        <a href="{{'http://127.0.0.1:8000/restorePassword/'.$user['token']}}"
                                           class="btn">Сбросить пароль</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
